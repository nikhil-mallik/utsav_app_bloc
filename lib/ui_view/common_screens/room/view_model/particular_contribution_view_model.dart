...
class ParticularContributionViewModel {
  // Method to fetch contribution details for a specific room
  Future<QuerySnapshot<Map<String, dynamic>>> getContributionDetails(
  ...
  // Widget to display contribution details
  Widget listItem({required Map contribution}) {
                                ...
                                children: [
                                  Text(
                                    "${contribution['con_name']}"
                                                ...
                                                .length >
                                            40
                                        ? '${"${contribution['con_name']}".replaceAll(RegExp(r'\s{2,}'), ' ').trim().substring(0, 40)}...'
                                        : "${contribution['con_name']}"
